...
public class OfflinePaymentProofRowMapper implements RowMapper<OfflinePaymentProof> {
    ...
    public OfflinePaymentProof mapRow(ResultSet resultSet, int rowNum) throws SQLException {
        return new OfflinePaymentProof(
                ...
                resultSet.getBigDecimal("received_unsettled_amount"),
                resultSet.getBigDecimal("received_settled_amount"),
                resultSet.getString("received_collateral_settlement_operation_id"),
                resultSet.getString("received_collateral_settlement_reference_id"),
                resultSet.getObject("received_collateral_settled_at", OffsetDateTime.class),
